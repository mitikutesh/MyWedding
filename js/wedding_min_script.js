! function(a) {
  ...
  function c(b) {
    ...
    a.ajax({
      method: "POST",
      url: "https://formspree.io/mitikutesh@gmail.com",
      data: d,
      dataType: "json",
      success: function() {
  ...
  "" != b && a("header .wed_logo_animation").addClass("wed_logo_rotate_" + b), a("header .wed_logo_animation").lettering(), a("header .wed_logo_animation span").each(function() {
      var b = 0,
        c = 50,
        d = Math.floor(Math.random() * (c - b + 1) + b);
      a(this).css("transition-delay", "0." + d + "s")
    }),
    a(".wed_particles").length > 0 && a(".wed_particles").particleground({
      dotColor: "#fff",
      lineColor: "#fff",
      particleRadius: "3",
      lineWidth: "0.5"
    }), a(".jqueryFireFly").length > 0 && a(".jqueryFireFly").each(function() {
    ...
    }), a("#bgndVideo").length > 0 && a("#bgndVideo").YTPlayer(), a(".wed_timer").appear(function() {
      var b = a(this);
      b.countTo({
        from: 0,
        to: b.html(),
    ...
    }), a(".wed_slider_carousel").owlCarousel({
      navigation: !0,
      responsive: !0,
      ...
      touchDrag: !1,
      navigationText: ['<i class="ti ti-angle-left"></i>', '<i class="ti ti-angle-right"></i>']
    }), a(".wed_services_slider").owlCarousel({
      navigation: !0,
      responsive: !0,
      ...
      touchDrag: !1,
      navigationText: ['<i class="ti ti-angle-left"></i>', '<i class="ti ti-angle-right"></i>']
    }), a(".wed_team_slider_single").owlCarousel({
      navigation: !0,
      responsive: !0,
      responsiveRefreshRate: 200,
      responsiveBaseElement: window,
      ...
      touchDrag: !1,
      navigationText: ['<i class="ti ti-angle-left"></i>', '<i class="ti ti-angle-right"></i>']
    }), a(".wed_shop_item_slider").owlCarousel({
      navigation: !0,
      responsive: !0,
      responsiveRefreshRate: 200,
      responsiveBaseElement: window,
      ...
      touchDrag: !1,
      navigationText: ['<i class="ti ti-angle-left"></i>', '<i class="ti ti-angle-right"></i>']
    }), a(".wed_slide_gallery").owlCarousel({
      navigation: !0,
      responsive: !0,
      responsiveRefreshRate: 600,
      responsiveBaseElement: window,
    ...
    }), a(".wed_map_over").on("click", function(b) {
      a(this).parents(".wed_section_outter, .wed_inside_map").toggleClass("active_map")
    }), a(".wed_top_menu_mobile_link").on("click", function(b) {
      a(this).next(".wed_top_menu_cont").fadeToggle(), a(this).parents(".wed_light_nav").toggleClass("active")
    }), a(".wed_header_search").on({
      mouseenter: function() {
    ...
    }), a(".wed_music_content").on("click", function(b) {
      b.preventDefault(), a(this).next(".wed_iframe").toggleClass("active")
    }), a(".wed_go, .wed_top_menu_cont a").on("click", function(b) {
      var c = a(this);
      a("html, body").stop().animate({
        scrollTop: a(c.attr("href")).offset().top
      }, 2300), b.preventDefault()
  ...
  a("#nav-sidebar, .wed_top_menu_cont").onePageNav({
  ...
  }), a(".wed_mobile_menu_content .wed_parent").on("click", function(b) {
    a(this).find("ul").slideToggle(300)
  }), a(".wed_mobile_menu").on("click", function(b) {
    a(this).toggleClass("active"), a(".wed_mobile_menu_hor").toggleClass("active")
  }), a(".wed_header_search span").on("click", function(b) {
    a(this).next(".wed_header_search_cont").fadeToggle()
    ...
    }), a(".filter-button-group").on("click", "a", function() {
